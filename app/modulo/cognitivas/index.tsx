...
export default function ModuloCognitivas() {
  ...
  return (
    <View style={styles.contenedor}>
      ...
      <Text style={styles.descripcion}>Aqui podras iniciar el juego del modulo de Cognitivas.</Text>

      <View style={styles.espacioJuego}>
        <Text style={styles.textoEspacio}>Espacio previo del juego.</Text>
      </View>

      <Pressable style={styles.botonIniciar} onPress={() => router.push("/modulo/cognitivas/juego")}>
